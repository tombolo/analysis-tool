...
import { ChartMode, ToolbarWidget, ChartTitle } from '@deriv/deriv-charts';
...
// @ts-ignore
  ...
  return (
    <div className='md:w-full md:h-[60vh]'
    style={{ width: '90vw', height: '50vh', display: 'flex', justifyContent: 'start', alignItems: 'left', borderRadius: '10px', backgroundColor: 'white', boxShadow: '0 0 10px 0 rgba(0, 0, 0, 0.1)', margin: '0 auto', overflow: 'hidden', position: 'relative' }}>  
